...
mixin _$ForgotPasswordState {
 ...
 String get email; bool get isLoading; String? get errorMessage; String? get successMessage;
...
@override
int get hashCode => Object.hash(runtimeType,email,isLoading,errorMessage,successMessage);

@override
String toString() {
  return 'ForgotPasswordState(email: $email, isLoading: $isLoading, errorMessage: $errorMessage, successMessage: $successMessage)';
}
...
@useResult
$Res call({
 String email, bool isLoading, String? errorMessage, String? successMessage
});
...
/// Create a copy of ForgotPasswordState
/// with the given fields replaced by the non-null parameter values.
@pragma('vm:prefer-inline') @override $Res call({Object? email = null,Object? isLoading = null,Object? errorMessage = freezed,Object? successMessage = freezed,}) {
...
@optionalTypeArgs TResult maybeWhen<TResult extends Object?>(TResult Function( String email,  bool isLoading,  String? errorMessage,  String? successMessage)?  $default,{required TResult orElse(),}) {final _that = this;
switch (_that) {
case _ForgotPasswordState() when $default != null:
return $default(_that.email,_that.isLoading,_that.errorMessage,_that.successMessage);case _:
  return orElse();
...
@optionalTypeArgs TResult when<TResult extends Object?>(TResult Function( String email,  bool isLoading,  String? errorMessage,  String? successMessage)  $default,) {final _that = this;
switch (_that) {
case _ForgotPasswordState():
return $default(_that.email,_that.isLoading,_that.errorMessage,_that.successMessage);case _:
  throw StateError('Unexpected subclass');
...
@optionalTypeArgs TResult? whenOrNull<TResult extends Object?>(TResult? Function( String email,  bool isLoading,  String? errorMessage,  String? successMessage)?  $default,) {final _that = this;
switch (_that) {
case _ForgotPasswordState() when $default != null:
return $default(_that.email,_that.isLoading,_that.errorMessage,_that.successMessage);case _:
  return null;
...
class _ForgotPasswordState extends ForgotPasswordState {
  const _ForgotPasswordState({required this.email, required this.isLoading, this.errorMessage, this.successMessage}): super._();
...
/// Create a copy of ForgotPasswordState
/// with the given fields replaced by the non-null parameter values.
@override @pragma('vm:prefer-inline') $Res call({Object? email = null,Object? isLoading = null,Object? errorMessage = freezed,Object? successMessage = freezed,}) {
